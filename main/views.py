...
class post_internship(View):
    ...
    def get(self, request):
        ...
        return render(request = request, template_name = "company/post_internship.html", context={"form":form, "categories" : categories, "locations" : locations}) 
...
def internship_detail(request,internship_id):
    ...
    return render(request,"student/internship_details.html",{'internship' : internship, 'student' : applicant, "form" : form})
...
class all_internships(View):
    ...
    def get(self,request):
        ...
        return render(request=request,
                      ...
                      context={"jobs":Internship.objects.all().order_by('-date_published')},
                    )  
    def post(self,request):
        print("---------Post------------------")
